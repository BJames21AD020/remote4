...
const Graph = () => {
  ...
  const { returnDistance, returnDuration, returnReps, returnDurPlank } =
    dataFunction(value);
          ...
          >
            {value === "cycling" && (
              <ChartMixed
                ...
                value="cycling"
                goalTarget={
                  goals.find((goal) => goal.name === "cycling") &&
                  goals.find((goal) => goal.name === "cycling").target
                }
            ...
            {value === "running" && (
              <ChartMixed
                ...
                value="running"
                goalTarget={
                  goals.find((goal) => goal.name === "running") &&
                  goals.find((goal) => goal.name === "running").target
                }
              />
            )}
            {value === "pushup" && (
              <ChartSingle
                ...
                value="pushup"
                goalTarget={
                  goals.find((goal) => goal.name === "pushup") &&
                  goals.find((goal) => goal.name === "pushup").target
                }
              />
            )}
            {value === "pullup" && (
              <ChartSingle
                ...
                value="pullup"
                goalTarget={
                  goals.find((goal) => goal.name === "pullup") &&
                  goals.find((goal) => goal.name === "pullup").target
                }
              />
            )}
            {value === "squat" && (
              <ChartSingle
                ...
                value="squat"
                goalTarget={
                  goals.find((goal) => goal.name === "squat") &&
                  goals.find((goal) => goal.name === "squat").target
                }
              />
            )}
            {value === "plank" && (
              <ChartSingle
                ...
                value="plank"
                goalTarget={
                  goals.find((goal) => goal.name === "plank") &&
                  goals.find((goal) => goal.name === "plank").target
                }
              />
            )}
          </Paper>
